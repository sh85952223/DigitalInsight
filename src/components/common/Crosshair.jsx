...
const Crosshair = ({ color = '#06b6d4', containerRef = null }) => {
    ...
    useEffect(() => {
        ...
        // Target elements with data-hover="true"
        const interactiveElements = document.querySelectorAll('[data-hover="true"]');
